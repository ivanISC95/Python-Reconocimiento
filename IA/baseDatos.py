...
nombre = "Tapaboca" # ESTA CARPETA SE CREA UNA VEZ, DESPUES SE CREA LA CARPETA SIN TAPABOCA
direccion = 'C:/Users/pepe/Music/IA/Fotos' # DIRECCION DONDE SE GUARDAN LAS FOTOS
...
cap = cv2.VideoCapture(0) # aqui se establece la camara
